...
import { ArrowUpRight, GroupIcon, Users } from "lucide-react"
...
export default function CardOverview({session, detailOverview} :CardOverviewProps): JSX.Element{
  ...
  return (
    <div className="grid grid-rows gap-3">
      <div>
      <Card className="w-full max-w-4xl bg-primary text-white p-6 overflow-hidden relative h-80">
